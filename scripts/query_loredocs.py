...
Use this from any agent session when LoreDocs MCP tools are not available
(common in Cowork scheduled tasks).
...
Usage:
    ...
    python scripts/query_loredocs.py --info "Project Ron - Deliverables"
    ...
    python scripts/query_loredocs.py --add-doc \
        ...
        --name "OPP-015 Architecture Proposal" \
        --file docs/internal/opp015_architecture.md \
        --tags '["architecture", "agent:gina"]' \
